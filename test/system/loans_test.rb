...
class LoansTest < ApplicationSystemTestCase
  ...
  test "should create loan" do
    ...
    fill_in "Borrower", with: @loan.borrower_id
    fill_in "Interest rate", with: @loan.interest_rate
    fill_in "Referral agent", with: @loan.referral_agent_id
    fill_in "Start date", with: @loan.start_date
    fill_in "Status", with: @loan.status
    fill_in "Term months", with: @loan.term_months
  ...
  test "should destroy Loan" do
    visit loan_url(@loan)
    accept_confirm { click_on "Destroy this loan", match: :first }
